...
local_infra_destroy:
	...
	docker-machine ls
local_swarm_create:
	./swarm/local/buildSwarmVM.sh master "for=nginx,broker=1,storage=1"
	./swarm/local/buildSwarmVM.sh 1 "for=app,manager=1"
	./swarm/local/buildSwarmVM.sh 2 "for=app,manager=2"
	docker-machine ls
local_swarm_destroy:
